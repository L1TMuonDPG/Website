...
- `$plot_extensions`: Extensions of files to show as plots in cards. Defaults to `("png", "pdf", "jpg", "jpeg", "gif")`.
- `$additional_extensions`: Additional extensions to link in plot card footer if existing. Defaults to `("eps", "svg", "root", "cxx", "txt", "rtf", "log", "csv")`.
